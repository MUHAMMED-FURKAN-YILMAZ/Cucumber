...
public class PDFGenerator {
    ...
    public static void pdfGeneratorRowsAndCells(String header, String fileName) {
        ...
        String pdf_path = fileName;
        String pdf_title = header;
    //    String logo_path = "/Users/ibrahimkalin/Downloads/Techproed.jpg"; -->pdf'ye logo eklenme isterse
        List<String> headers = new ArrayList<String>();
...
//          document.add(Image.getInstance(logo_path));
    ...
    public static void pdfGeneratorRowsAndCellsWithList(String title, List<Customer> list, String fileName) {
       ...
       // String logo_path = "src/Test_Data/img.png";
        List<String> headers = new ArrayList<String>();
        headers.add("ID");
    ...
    public static void main(String[] args) {
        ...
        String fileName = "src/Test_Data/pdfGenerator.pdf";
...
//        customers.add(customer2);
        ...
        pdfGeneratorRowsAndCells(title,fileName);
...
*/
    ...
    public static void pdfGeneratorRowsAndCellsWithListFirstToThirtyStates(String header, List <States> list, String
            fileName){
        ...
        try {
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                table.addCell(String.valueOf(list.get(i)));
...
// **************************************************************************************************
    ...
    public static void pdfGeneratorRowsAndCellsWithListFirstToThirtyCustomer(String header, List <Customer> list, String
            fileName){
        ...
        headers.add("Customer FIRSTNAME");
    ...
    public static void pdfGeneratorRowsAndCellsCustomer(String header, String fileName) {
        ...
        List<String> rowData = new ArrayList<String>();
        rowData.add(String.valueOf(customer.getId()));
        rowData.add(customer.getFirstName());
        rowData.add(customer.getLastName());
        rowData.add(customer.getEmail());
        rowData.add(customer.getCity());
